...
public class MultipartRequest
{
	...
	/**
	 * Check encoding is KSC5601
	 * 
	 * @param	Unicodestr	java.lang.String. ISO8859_1 CharacterSet
	 * @return	boolean		KSC5601 -> true, or false return.
	 */
	protected boolean isKSC5601(String Unicodestr) {
	...
	/**
	 * Change Encoding ISO8859_1 -> KSC5601
	 * 
	 * @param	Unicodestr	java.lang.String. ISO8859_1 CharacterSet
	 * @return	java.lang.String	KSC5601 CharacterSet
	 */
	protected String KSC5601(String Unicodestr)
	{
	 ...
	 * @exception java.io.IOException if there's a problem reading or parsing the
	 * request
	 *
	 * @see readParameter
	 * @see readAndSaveFile
		...
		throws IOException
	{
		...
		String filename = KSC5601(dispInfo[2]);
		...
		else
		{
			...
			// ���� �̸��� �ߺ��� ���ϱ� ���� �����ڸ� �ξ��.
			// �ߺ��� ���ϱ� ���Ͽ� ���� �߻� + ���� 3 �ڸ� + "_"
			String indicator = KUtil.getTimeMillis() + "_";

			readAndSaveFile(in, boundary, filename, contentType, indicator);
	...
	protected void readAndSaveFile(MultipartInputStreamHandler in,
		String boundary, String filename, String contentType, String indicator) throws IOException
	{
		...
		{
			File f = new File(dir + File.separator + indicator + filename);
